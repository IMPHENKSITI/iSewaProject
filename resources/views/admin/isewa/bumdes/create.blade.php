...
<div class="container-fluid py-4">
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <!-- HEADER -->
            <h2 class="text-primary fw-bold mb-4">Tambah <span class="text-info">Anggota BUMDes</span></h2>
            ...
            <div class="card shadow-sm border-0 rounded-4 p-4" style="background: linear-gradient(135deg, #ffffff 0%, #fff9e6 100%);">
                <form action="{{ route('admin.isewa.bumdes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div id="preview-container" class="border rounded-circle overflow-hidden" style="width: 120px; height: 120px; background: #f5f7fa;">
                                <img id="preview-image" src="http://isewaproject.test/Admin/img/avatars/default.png" alt="Preview" class="w-100 h-100 object-fit-cover">
                            </div>
                            <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg" placeholder="Contoh: Muhammad Mawardi" required>
                    </div>

                    <!-- JABATAN -->
                    <div class="mb-4">
                        <label class="form-label fw-semibold">Jabatan</label>
                        <input type="text" name="position" class="form-control form-control-lg" placeholder="Contoh: Sekretaris Desa" required>
                    </div>
...
function clearPhoto() {
    ...
    input.value = '';
    preview.src = 'http://isewaproject.test/Admin/img/avatars/default.png';
