...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // WHITELIST untuk Google (Socialite & Maps dll)
        $csp = implode('; ', [
            "default-src 'self'",
            ...
            "connect-src 'self' https://googleapis.com https://*.googleapis.com https://accounts.google.com", // FIX: Whitelist connect-src for Google API
